...
import com.example.rescueandroidapp.Framgment.MainFrameActivity;
...
import com.rescueandroid.update.network.DownloadManager.UpdateShared;
...
public class DownloadInstall implements DownloadCallback {
	...
	public void onDownloadPreare() {
		if (IntentUtil.checkSoftStage(mContext)) {
			...
			Builder builder = new AlertDialog.Builder(MainFrameActivity.mainActivity);
