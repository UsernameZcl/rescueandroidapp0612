...
public class JavaInterfaceUtils {
    ...
    //发车到站地点  /*, String toAddr, String fromTime, String toTime*/
    public static LinearLayout createAddr(Activity activity, String startAddr) {
        ...
        linear.addView(createText(activity, "仓库地址", small_textSize));
...
//        linear.addView(createText(activity, "装车时间：" + fromTime + " → " + toTime, medium_textSize));
    ...
    //发车到站地点
    public static LinearLayout createAddr12(Activity activity, String startAddr, String toAddr, String fromTime, String toTime) {
        LinearLayout linear = new LinearLayout(activity);
        linear.setOrientation(LinearLayout.VERTICAL);
        linear.setBackgroundColor(Color.WHITE);
        linear.setPadding(small_padding, sssmall_padding, small_padding, sssmall_padding);
    ...
    public static TextView createText(Activity activity, String text, int textSize) {
        TextView textView = new TextView(activity);
        textView.setText(TextViewUtils.judgeNull(text));
