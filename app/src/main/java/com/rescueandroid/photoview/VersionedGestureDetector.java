...
import com.rescueandroid.photoview.gestures.GestureDetector;
...
//					mIsDragging = FloatMath.sqrt((dx * dx) + (dy * dy)) >= mTouchSlop;
		...
		@Override
		public void setOnGestureListener(com.rescueandroid.photoview.gestures.OnGestureListener listener) {
