package com.example.rescueandroidapp.Framgment.OrderFragment.model;
...
public class MyOrderPay implements Serializable {
    private String id;
    ...
    public void setDeletionstatecode(String deletionstatecode) {
