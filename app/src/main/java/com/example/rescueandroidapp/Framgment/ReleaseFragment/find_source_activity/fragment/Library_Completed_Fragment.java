 ...
 */
//已完成
public class Library_Completed_Fragment extends Fragment {
    ...
    private void Library_Completed_Fragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mInflate = inflater.inflate(R.layout.library_completed_fragment, null, false);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
       mListView= (ListView) mInflate.findViewById(R.id.library_completed_fragment_lv);
        mTextView= (TextView) mInflate.findViewById(R.id.library_completed_fragment_tv);
