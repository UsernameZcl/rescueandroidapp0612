...
public class Cargo_type_Popwindow extends PopupWindow implements View.OnClickListener {
    private Context mContext;
    private TextView btnSure;
    private TextView btnCancel;
    private View lyChangeAddressChild;
    private final WheelView mType;
    private String strProvince = "常温";
    // TODO: 2017/5/2
    ...
    public Cargo_type_Popwindow(Context context) {
        super(context);
        mContext = context;
