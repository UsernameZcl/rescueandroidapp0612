...
public class Required_temperature_Popwindow_One extends PopupWindow implements View.OnClickListener {
    private Context mContext;
    private TextView btnSure;
    private TextView btnCancel;
    private View lyChangeAddressChild;
    private final WheelView mType;
    private String strProvince = "-50";
    // TODO: 2017/5/2
...
private  int mInt;
    public Required_temperature_Popwindow_One(Context context,int i) {
