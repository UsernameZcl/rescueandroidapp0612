 ...
 */
//求库中
public class Request_Library_Fragment extends Fragment {
    ...
    private void Request_Library_Fragment() {}
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        mInflate = inflater.inflate(R.layout.request_library_fragment, null, false);
        // 获取用户名
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        mListView = (ListView) mInflate.findViewById(R.id.request_library_fragment_lv);
        mTextView = (TextView) mInflate.findViewById(R.id.request_library_fragment_tv);
