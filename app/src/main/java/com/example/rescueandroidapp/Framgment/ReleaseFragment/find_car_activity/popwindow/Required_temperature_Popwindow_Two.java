...
public class Required_temperature_Popwindow_Two extends PopupWindow implements View.OnClickListener {
...
private  int mInt ;
    ...
    public Required_temperature_Popwindow_Two(Context context ,int i ) {
