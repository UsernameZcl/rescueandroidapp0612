 ...
 */
//运输中
public class In_transit_Fragment extends Fragment {
    ...
    public In_transit_Fragment() {
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mInflate = inflater.inflate(R.layout.in_transit_fragment, null, false);
        // 获取用户名
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        mListView = (ListView) mInflate.findViewById(R.id.in_transit_fragment_lv);
        mTextView = (TextView) mInflate.findViewById(R.id.in_transit_fragment_tv);
    ...
    private void init() {
        new Thread() {
            ...
            public void run() {
                ...
                String format = String.format(KeyPath.Path.head + KeyPath.Path.for_car, mUserName, mUserPass, 1);
