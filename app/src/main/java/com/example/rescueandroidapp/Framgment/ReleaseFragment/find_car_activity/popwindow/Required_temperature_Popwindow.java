...
/**
 * Created by ZCL on 2017/5/3.
 */

public class Required_temperature_Popwindow extends PopupWindow implements View.OnClickListener {
   ...
   private  ArrayList<String> strings1 = new ArrayList<>();
    ...
    public Required_temperature_Popwindow(Context context) {
        super(context);
        mContext = context;
