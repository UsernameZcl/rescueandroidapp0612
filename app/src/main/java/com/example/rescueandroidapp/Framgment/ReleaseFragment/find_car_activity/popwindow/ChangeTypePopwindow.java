...
public class ChangeTypePopwindow extends PopupWindow implements View.OnClickListener {
    ...
    private String strProvince = "水产品";
    private int key = 0;
    // TODO: 2017/5/2
    ...
    public ChangeTypePopwindow(Context context) {
        super(context);
        mContext = context;
...
//		this.setAnimationStyle(R.style.AnimBottom);
  ...
  String[] strings = {"水产品","速冻食品","果蔬","肉类","医药","其他",};
    ...
    public void onClick(View view) {
        ...
        if (view == btnSure) {
            if (onAddressCListener != null) {
                onAddressCListener.onClick(strProvince, key);
            }
