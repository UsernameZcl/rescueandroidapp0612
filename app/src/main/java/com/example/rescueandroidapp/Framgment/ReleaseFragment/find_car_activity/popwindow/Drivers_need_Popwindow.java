...
//需要车长
public class Drivers_need_Popwindow extends PopupWindow implements View.OnClickListener {
    private Context mContext;
    private TextView btnSure;
    private TextView btnCancel;
    private View lyChangeAddressChild;
    private final WheelView mType;
    private String strProvince = "4.2米以下";
    // TODO: 2017/5/2
    ...
    public Drivers_need_Popwindow(Context context) {
        super(context);
        mContext = context;
...
//		this.setAnimationStyle(R.style.AnimBottom);
    ...
    private List<String> initDatas() {
        String[] strings = {"4.2米以下","4.2-7.2米下","7.2-9.6米以下","9.6米以上"};
