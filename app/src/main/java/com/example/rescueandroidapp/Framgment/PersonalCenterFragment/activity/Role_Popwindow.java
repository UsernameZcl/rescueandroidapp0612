 ...
 */
//可选角色的弹窗
public class Role_Popwindow extends PopupWindow implements View.OnClickListener {
    private Context mContext;
    private TextView btnSure;
    private TextView btnCancel;
    private View lyChangeAddressChild;
    private final WheelView mType;
    private String strProvince = "货主";
    // TODO: 2017/5/2
    ...
    public Role_Popwindow(Context context) {
        super(context);
        mContext = context;
